...
module TypeInformationDatabaseGenerator
  ...
  class BuiltinDatabase
    attr_reader :generated_classes, :generated_methods, :class_identifiers,
                :enumeration_names, :name_pool, :signature_pool,
                :document_pool, :union_pool

    def initialize(collected_classes, signature_environment)
    ...
    def resolve_overload_return_types(
      ...
      resolved_types = collected_method.overloads.map do |overload|
        @return_type_resolver.resolve_return_type(
    ...
    def resolve_block_parameter_identifier(
      ...
      collected_method.overloads.each do |overload|
        ...
        if method_block
          ...
          if block_parameter
            resolved_type = @return_type_resolver.resolve_return_type(
