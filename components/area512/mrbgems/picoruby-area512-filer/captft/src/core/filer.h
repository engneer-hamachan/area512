...
#define FILER_FONT_SIZE 8
#define HEADER_HEIGHT 36
#define BAR_HEIGHT 14
#define FRAME_INSET 8
#define FRAME_RADIUS 12
#define FRAME_TOP 20
#define FRAME_BOTTOM_HEIGHT 8

#define CONTENT_X (FRAME_INSET + 5)
#define CONTENT_RIGHT (SCREEN_WIDTH - FRAME_INSET - 8)
#define CONTENT_COLUMNS ((CONTENT_RIGHT - CONTENT_X) / FILER_CHAR_WIDTH)

#define ROWS_VISIBLE \
  ((SCREEN_HEIGHT - HEADER_HEIGHT - BAR_HEIGHT * 2 - FRAME_BOTTOM_HEIGHT - \
    FRAME_INSET) / ROW_HEIGHT)
#define BAR1_Y (HEADER_HEIGHT + ROWS_VISIBLE * ROW_HEIGHT)
#define BAR2_Y (BAR1_Y + BAR_HEIGHT)
#define CLOSE_Y (BAR2_Y + BAR_HEIGHT)

#define PANEL_WIDTH 120
#define PANEL_HEIGHT 85
#define PANEL_GAP 6
#define PANEL_RIGHT (SCREEN_WIDTH - FRAME_INSET - 14)
#define PANEL_X (PANEL_RIGHT - PANEL_WIDTH)
#define PANEL_COLUMNS ((PANEL_X - PANEL_GAP - CONTENT_X) / FILER_CHAR_WIDTH)
...
void area512_filer_open_window(Filer *filer);
